...
if __name__ == '__main__':
    ...
    for prediction_type in target:
            ...
            output_path = pl.Path(f'/home/lorenz/BMDataAnalysis/MICCAI_submission/GML_time-specific')
            ...
            for i in range(1, len(data_prefixes)):
                ...
                for fold, (train_idx, val_idx) in enumerate(skf.split(data, data['t6_rano'])):
                    ...
                    # evaluate
                    best_res = torch_engine.test_classification(best_model, dataset_test, wdir, device, rano_encoding, True)
