...
########## setup
    ...
    for i, config in enumerate(options):
        ...
        output_path = pl.Path(f'/home/lorenz/BMDataAnalysis/final_output/graph_ml_general_5fold')
        ...
        extra_data = [c for c in data.columns if not (c.startswith('ignored') or c.split('_')[0] in data_prefixes or c=='Lesion ID')]
