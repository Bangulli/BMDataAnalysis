...
if __name__ == '__main__':
    ...
    _, res_quant = train_classification_model_sweep(model, train_data, test_data, data_prefixes=data_prefixes, rano_encoding={'CR':0, 'non-CR':1}, prediction_targets=rano_cols)
